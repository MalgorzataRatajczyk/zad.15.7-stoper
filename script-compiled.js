...
var Stopwatch = function (_React$Component) {
    ...
    _createClass(Stopwatch, [{
        ...
        value: function addListItem() {
            var listItem = this.format(this.state.times);
            var listResults = [].concat(_toConsumableArray(this.state.listResults), [listItem]);
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'ul',
                    { className: 'results' },
                    this.state.listResults.map(function (item) {
                        return React.createElement(
                            'li',
                            { key: item },
                            item
